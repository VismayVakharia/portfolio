    ...
    <div class="container mx-auto px-6 flex flex-col md:flex-row items-center">
      <div class="md:w-1/2 flex justify-center mb-10 md:mb-0">
        <div class="relative">
          ...
          <div class="absolute -bottom-4 -right-4 bg-indigo-400 dark:bg-indigo-600 text-black dark:text-white px-4 py-2 rounded-lg shadow-lg">
      ...
      <div class="md:w-1/2 md:pl-12">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Hi, I'm <span class="bg-gradient-to-r from-indigo-600 to-indigo-400 dark:from-indigo-600 dark:to-indigo-400 bg-clip-text text-transparent">${name}</span></h1>
        ...
        <div class="flex mt-8 space-x-4">
          <!--
          <a href="#contact" class="bg-indigo-400 dark:bg-indigo-600 hover:bg-indigo-300 dark:hover:bg-indigo-700 text-black dark:text-white px-6 py-3 rounded-lg 
            transition-colors duration-300 flex items-center">
            <i class="fas fa-envelope mr-2"></i> Contact Me
          </a>
          -->
          <a href="${resumeURL}" target="_blank" class="border border-indigo-400 dark:border-indigo-600 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-400 dark:hover:bg-indigo-600 hover:text-black dark:hover:text-white 
            px-6 py-3 rounded-lg transition-colors duration-300 flex items-center">
